...
### Cinematic Quality — 25% · owner: Water, with Fire
...
### Storytelling & Creativity — 25% · owner: Fire
...
- Originality — Void's job is to keep us off the crowded paths (dystopian cityscape,
...
### Technical Execution — 20% · owner: Earth, with Water
...
directly feeds this 20%, and Wind can turn it into campaign content.

### Platform Engagement — 15% · owner: Wind
...
### Social Media Engagement — 15% · owner: Wind
...
1. **Survive Screening.** Compliance perfect. Runtime ≥3:00. Watermark present.
   ...
   reviewer on entry #400.** This is Fire's hook, and at Screening it matters more
...
let secondaries cannibalize the primary. Void owns this call and revisits it as the
calendar tightens.

### B. Two independent money paths
The jury path and the **Audience Choice ($100,000)** path are separate. A film can
lose the jury and still take $100K on reach alone. This makes Wind's 30% doubly
...
submittable. `[VERIFY]` cross-entry rules with Earth before relying on this.
...
considers award-grade. Void mines this first.
...
|---|---|---|---|
| Cinematic Quality | 25% | ≥8 | Water |
| Storytelling & Creativity | 25% | ≥9 | Fire |
| Technical Execution | 20% | ≥8 | Earth |
| Platform Engagement | 15% | ≥9 | Wind |
| Social Media Engagement | 15% | ≥9 | Wind |

**If the weighted total is below 8.0 at the rough-cut gate, we have a problem Void
